...
public class HighscoresView {
  ...
  private void drawNameInput() {
    ...
    text.drawText(center, 70, 255, 255, 255, TextAlignment.CENTER, "YAY! IT'S A HIGHSCORE!");
    text.drawText(center, 120, 255, 255, 255, TextAlignment.CENTER, "ENTER YOUR NAME:");
    text.drawText(center, 250, 128, 255, 128, TextAlignment.CENTER, name);
    ...
    text.drawText(center, 625, 255, 255, 255, TextAlignment.CENTER, "PRESS RETURN TO CONFIRM");
  }
